...
!(function (typedoc) {
                    ...
                    components.forEach(function (c) {
                        (c.namespace != namespace && '*' != c.namespace) ||
                            context.querySelectorAll(c.selector).forEach(function (el) {
                                el.dataset.hasInstance || (new c.constructor({ el: el }), (el.dataset.hasInstance = String(!0)));
                            });
                    });
            }),
            Application
            ...
            return (
                ...
                (EventTarget.prototype.removeEventListener = function (type, callback) {
                    if (type in this.listeners)
                        for (var stack = this.listeners[type], i = 0, l = stack.length; i < l; i++) if (stack[i] === callback) return void stack.splice(i, 1);
                }),
                (EventTarget.prototype.dispatchEvent = function (event) {
                    if (!(event.type in this.listeners)) return !0;
                    for (var stack = this.listeners[event.type].slice(), i = 0, l = stack.length; i < l; i++) stack[i].call(this, event);
                ...
                (Viewport.prototype.hideShowToolbar = function () {
                    ...
                    (this.showToolbar = this.lastY >= this.scrollTop || 0 === this.scrollTop),
                        isShown !== this.showToolbar &&
                            (this.toolbar.classList.toggle('tsd-page-toolbar--hide'), this.secondaryNav.classList.toggle('tsd-navigation--toolbar-hide')),
    ...
    (function (typedoc) {
        (typedoc.pointerDown = 'mousedown'),
            ...
            typedoc.isMobile &&
                ...
                ((typedoc.isPointerTouch = !0), (typedoc.pointerDown = 'touchstart'), (typedoc.pointerMove = 'touchmove'), (typedoc.pointerUp = 'touchend')),
    ...
    (function (typedoc) {
            ...
            FilterItemSelect = (function (_super) {
                ...
                return (
                    ...
                    (FilterItemSelect.prototype.handleValueChange = function (oldValue, newValue) {
                        ...
                        selected && label && (selected.classList.add('selected'), (label.textContent = selected.textContent)),
        ...
        Filter.isSupported() ? typedoc.registerComponent(Filter, '#tsd-filter') : document.documentElement.classList.add('no-filter');
    })(typedoc || (typedoc = {})),
    (function (typedoc) {
        var MenuHighlight = (function (_super) {
            ...
            return (
                ...
                (MenuHighlight.prototype.onScroll = function (event) {
                    for (
                        var scrollTop = event.detail.scrollTop + 5, anchors = this.anchors, count = anchors.length - 1, index = this.index;
        ...
        !(function (search) {
            ...
            var Search = (function (_super) {
                function Search(options) {
                    ...
                    return (_this.field = field), (_this.results = results), (_this.base = _this.el.dataset.base + '/'), _this.bindEvents(), _this;
                }
                return (
                    ...
                    (Search.prototype.loadIndex = function () {
                        ...
                        if (this.loadingState == SearchLoadingState.Idle && !this.data) {
                            setTimeout(function () {
                                _this.loadingState == SearchLoadingState.Idle && _this.setLoadingState(SearchLoadingState.Loading);
                            }, 500);
                            ...
                            url
                                ? fetch(url)
                                      ...
                                      .then(function (source) {
                                          (_this.data = source), (_this.index = lunr.Index.load(source.index)), _this.setLoadingState(SearchLoadingState.Ready);
                                      })
                    ...
                    (Search.prototype.updateResults = function () {
                        if (this.loadingState == SearchLoadingState.Ready && ((this.results.textContent = ''), this.query && this.index && this.data)) {
                    ...
                    (Search.prototype.setCurrentResult = function (dir) {
                        ...
                        } else (current = this.results.querySelector(1 == dir ? 'li:first-child' : 'li:last-child')) && current.classList.add('current');
                    }),
                    ...
                    (Search.prototype.bindEvents = function () {
                        ...
                        this.results.addEventListener('mousedown', function () {
                            ...
                            document.body.addEventListener('keydown', function (e) {
                                e.altKey || e.ctrlKey || e.metaKey || (!_this.hasFocus && 47 < e.keyCode && e.keyCode < 112 && _this.field.focus());
                            });
                    }),
                    Search
                );
        ...
        var SignatureGroup = (function () {
                ...
                return (
                    ...
                    (SignatureGroup.prototype.removeClass = function (className) {
                        return this.signature.classList.remove(className), this.description.classList.remove(className), this;
                    }),
                    SignatureGroup
                );
            })(),
